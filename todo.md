...
- [x] Substituir a galeria estreita por uma apresentação com imagens maiores e proporções naturais.
- [x] Reformular o texto do Lumi para o descrever explicitamente como um vaso de plantas que gera energia.
- [x] Rever a composição da secção em desktop e mobile e guardar um novo checkpoint.

- [x] Preparar o logótipo oficial para utilização no cabeçalho, rodapé e favicon.
- [x] Copiar e optimizar as fotografias reais fornecidas pela equipa para o armazenamento de activos web.
...
## Desempenho de carregamento e scroll
...
- [x] Publicar a gestão de equipa e sincronizá-la com o GitHub.

## Pontos Lumi instalados

- [x] Definir o modelo de dados dos pontos Lumi, empresa associada, localização, estado e observações.
- [x] Criar procedimentos protegidos para listar, cadastrar e eliminar pontos Lumi.
