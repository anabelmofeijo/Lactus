...
const markImage = `${STORAGE}lactus-mark_74047797.png`;
    ...
    <div className="lactus-site">
      <header className={`site-header${menuOpen ? " site-header--open" : ""}`}>
        <a className="brand" href="#top" aria-label="Lactus — início">
          ...
          <span className="brand-name">LACTUS</span>
        </a>
      ...
      <main id="top">
        ...
        <section className="lumi-section section-pad" id="lumi">
          ...
          <div className="lumi-copy"><FieldLabel light>03 / O PRIMEIRO PASSO</FieldLabel><h2>Conheça o <em>Lumi</em>.</h2><p className="section-lead section-lead--light">Uma solução de bioenergia que explora a interacção natural entre as raízes das plantas e os microrganismos do solo para gerar electricidade.</p><p className="body-light">Sem prejudicar a planta, o sistema foi pensado para alimentar LEDs de sinalização e sensores ambientais — necessidades pequenas, mas decisivas em lugares onde as alternativas convencionais são caras ou pouco adequadas.</p><div className="lumi-specs"><div><strong>5V</strong><span>por planta</span></div><div><strong>4</strong><span>LEDs de alto brilho</span></div><div><strong>01</strong><span>protótipo em validação</span></div></div><a className="button button--outline-light" href="#pilotos">Ver o caminho do piloto <ArrowUpRight size={16} /></a></div>
        </section>
